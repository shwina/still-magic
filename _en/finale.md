...
Ever since {% include b key="Wing2006" %} introduced the term "computational thinking" in 2006,
computer scientists and educators have debated what exactly it means {% include b key="Denn2017" %}.
...
"Seven Ways to Think Like the Web" {% include b key="Udel2011" %}.*
...
you have written a few programs, but thirty years after {% include b key="Pea1986" %} first
...
{% include b key="Mill1956" %}, we have to create abstractions so that our representations
...
spot {% include b key="Nath2003" %}. Once experts have internalized patterns, they are
...
One special case of this rule is automating workflows. As {% include b key="Whit1958" %}
...
to solve {% include b key="Cone2016" %}. Some algorithms slow down gently as their inputs
...
on a single machine {% include b key="Wald1994" %}. On a single computer, we can usually
