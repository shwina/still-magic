...
We will explain how to implement continuous integration in [s:integrate](#REF).
...
read the discussion of crunch mode in [s:pacing](#REF).)
At this point,
