...
{% include figure.html id="f:docs-error-message" src="../../figures/docs-error-message.png" caption="Error Message" %}
...
:   [s:backlog](#REF) explained the value of a [reproducible example](#g:reprex) (reprex),
